...
def seed_pharmacy_catalog(apps, schema_editor):
    ...
    MedicineStock = apps.get_model('inventory', 'MedicineStock')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0003_alter_medicine_table_alter_medicinestock_table_and_more'),
    ]

    operations = [
        migrations.RunPython(seed_pharmacy_catalog, reverse_noop),
    ]
