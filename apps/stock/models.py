# models for medicine catalog and stock batch management
...
class MedicineStock(models.Model):
    ...
    supplier = models.ForeignKey('supplier.Supplier', on_delete=models.SET_NULL, null=True, blank=True, related_name='stock_batches')  # which supplier delivered this batch
